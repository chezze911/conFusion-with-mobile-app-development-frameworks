  ...
  $scope.doLogin = function() {
    ...
    $timeout(function() {
      $scope.closeLogin();
       ...
       .controller('MenuController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', '$localStorage', 'dishes', function ($scope, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast, $localStorage, dishes) {
